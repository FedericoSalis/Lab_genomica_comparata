...
# Mapping short reads on assembly. Mutate SAM in to BAM
...
# Long reads
minimap2 -ax map-pb --MD -t 6 Anoste_raw.fasta SRR11672503_1_paired.fastq SRR11672503_2_paired.fastq > Anoste_raw_lr.sam
...
samtools index Anoste_raw_lr__sorted.bam
